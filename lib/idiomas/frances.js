...
//_allantilink.js
const smsTextoYT = () => { return '𝗦𝘂𝗽𝗲𝗿 SxntBot  - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsJBInfo2 = () => { return ` *La función es estable, sí presenta algún inconveniente Comuníquese al correo: fabersantiagoyt84@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
